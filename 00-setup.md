...
- ✅ **Claude Desktop** (for testing with Claude) - [Download here](https://claude.ai/download)
...
> **📦 Package Info:** The MCP package is available on [PyPI](https://pypi.org/project/mcp/) as `mcp`.
...
| **🔔 Notifications** | Monitor real-time logs and notifications from your server |
...
4. **Test a tool:**
   ...
   - Click **"Run Tool"**
   - See the result: `"Hello, Alice! Welcome to the world of MCP! 🎉"`
...
- 📚 [Example Servers Repository](https://github.com/modelcontextprotocol/quickstart-resources)
- 🎓 [ApXML MCP Course](https://apxml.com/courses/getting-started-model-context-protocol)
